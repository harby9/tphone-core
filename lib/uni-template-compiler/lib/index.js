...
} = require('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/vue-template-compiler')
...
module.exports = {
  compile (source, options = {}) {
    if ( // 启用摇树优化后,需要过滤内置组件
      ...
      options.autoComponentResourcePath.indexOf('@tphone-beta/core/lib/uni-h5/src') === -1
    ) {
    ...
    if (options.service) {
      ...
      // 后续改版，应统一由具体包实现
      options.modules.push(require('@tphone-beta/core/lib/uni-quickapp-native/lib/compiler-module'))
    }
