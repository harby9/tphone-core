const {
  ...
  compileTemplate
} = require('@tphone/core/lib/uni-template-compiler/lib/auto-components')

const {
  isUnaryTag
} = require('@tphone/core/lib/uni-template-compiler/lib/util')
...
compiler.compile = function (source, options = {}) {
  ...
  options.modules.push(require('@tphone/core/lib/uni-template-compiler/lib/asset-url'))
  options.modules.push(require('@tphone/core/lib/uni-template-compiler/lib/bool-attr'))
