...
const WebpackUniMPPlugin = require('@tphone/core/lib/webpack-uni-mp-loader/lib/plugin/index-new')
...
const jsPreprocessorLoader = {
  loader: '@tphone/core/lib/vue-cli-plugin-uni/packages/webpack-preprocess-loader',
...
if (process.env.UNI_USING_NVUE_COMPILER || process.env.UNI_USING_V3_NATIVE) {
  rules.unshift({
    ...
    use: [{
      ...
      loader: '@tphone/core/lib/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta'
    }]
  })
}
rules.unshift({
