...
const VueLoaderPlugin = require('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/vue-loader/lib/plugin')
...
const fileLoader = require('@tphone-beta/core/lib/uni-cli-shared/lib/file-loader')
...
const WebpackErrorsPlugin = require('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/webpack-errors-plugin')
const WebpackUniMPPlugin = require('@tphone-beta/core/lib/webpack-uni-mp-loader/lib/plugin/index-new')

const onErrors = require('@tphone-beta/core/lib/vue-cli-plugin-uni/util/on-errors')
const onWarnings = require('@tphone-beta/core/lib/vue-cli-plugin-uni/util/on-warnings')

const cssLoaders = require('./css-loader.conf')
const vueLoaderOptions = require('./vue-loader.conf')

const jsPreprocessorLoader = {
  loader: '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/webpack-preprocess-loader',
...
const uniCloudPath = require.resolve('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/uni-cloud/dist/index.js')
...
if (
  ...
  provide.__f__ = [require.resolve('@tphone-beta/core/lib/vue-cli-plugin-uni/lib/format-log.js'), 'default']
  provide.crypto = [require.resolve('@tphone-beta/core/lib/vue-cli-plugin-uni/lib/crypto.js'), 'default']
}
...
if (process.env.NODE_ENV === 'development') {
  plugins.push(require('@tphone-beta/core/lib/uni-cli-shared/lib/source-map').createEvalSourceMapDevToolPlugin())
}
...
const rules = [{
  ...
  use: [{
    loader: '@tphone-beta/core/lib/webpack-uni-pages-loader'
  }],
  type: 'javascript/auto'
}, {
  test: path.resolve(process.env.UNI_INPUT_DIR, getNVueMainEntry()),
  use: [{
    loader: '@tphone-beta/core/lib/vue-cli-plugin-hbuilderx/packages/webpack-uni-nvue-loader/lib/main'
  }]
}, {
  test: /\.js$/,
  use: [{
...
if (process.env.UNI_USING_NVUE_COMPILER || process.env.UNI_USING_V3_NATIVE) {
  rules.unshift({
    ...
    use: [{
      loader: '@tphone-beta/core/lib/vue-cli-plugin-hbuilderx/packages/webpack-uni-nvue-loader/lib/template'
    }, {
      loader: '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta'
    }]
  })
}
rules.unshift({
  ...
  use: [{
    loader: '@tphone-beta/core/lib/vue-cli-plugin-hbuilderx/packages/webpack-uni-nvue-loader/lib/template.recycle'
  }]
})

if (process.env.UNI_USING_V3_NATIVE) {
  try {
    const automatorJson = require.resolve('@tphone-beta/core/lib/uni-automator/dist/automator.json')
      ...
      transform (content) {
        if (process.env.UNI_AUTOMATOR_WS_ENDPOINT) {
          return JSON.stringify({
            version: require('@tphone-beta/core/lib/uni-automator/package.json').version,
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        ...
        '@tphone-beta/core/lib/uni-stat': require.resolve('@tphone-beta/core/lib/uni-stat'),
