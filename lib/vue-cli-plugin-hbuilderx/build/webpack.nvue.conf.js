...
if (process.env.UNI_USING_V3_NATIVE) {
  try {
    const automatorJson = require.resolve('@tphone/core/lib/uni-automator/dist/automator.json')
      ...
      transform (content) {
        if (process.env.UNI_AUTOMATOR_WS_ENDPOINT) {
          return JSON.stringify({
            version: require('@tphone/core/lib/uni-automator/package.json').version,
