...
module.exports = (api, options) => {
  api.registerCommand('uni-build', {
    ...
    require('@tphone-beta/core/lib/vue-cli-plugin-uni/commands/util').initAutomator(args)
...
async function build (args, api, options) {
  ...
  if (
    ...
    webpackConfigs.push(require('@tphone-beta/core/lib/vue-cli-plugin-hbuilderx/build/webpack.nvue.conf.js')(process
      .UNI_NVUE_ENTRY))
  }
...
function buildManifestJson () {
  ...
  const res = require('@tphone-beta/core/lib/webpack-uni-pages-loader/lib/platforms/app-plus/index.js')(pagesJson,
    manifestJson,
    false)
  if (res && res[0]) {
    fs.outputFileSync(
