...
moduleAlias.addAlias('vue-template-compiler', '@tphone/core/lib/vue-cli-plugin-uni/packages/vue-template-compiler')
moduleAlias.addAlias('@megalo/template-compiler', '@tphone/core/lib/vue-cli-plugin-uni/packages/@megalo/template-compiler')
moduleAlias.addAlias('mpvue-template-compiler', '@tphone/core/lib/vue-cli-plugin-uni/packages/mpvue-template-compiler')
// vue-loader
moduleAlias.addAlias(
  'vue-loader',
  path.resolve(process.cwd(), 'node_modules/@tphone/core/lib/vue-cli-plugin-uni/packages/vue-loader')
);
// moduleAlias.addAlias('vue-loader', '@tphone/core/lib/vue-cli-plugin-uni/packages/vue-loader')
// sass-loader
moduleAlias.addAlias('sass-loader', '@tphone/core/lib/vue-cli-plugin-uni/packages/sass-loader')

if (process.env.UNI_USING_V3 && process.env.UNI_PLATFORM === 'app-plus') {
  moduleAlias.addAlias('./runtime/getUrl.js', '@tphone/core/lib/vue-cli-plugin-uni/lib/app-plus/getUrl.js')
  moduleAlias.addAlias('../runtime/getUrl.js', '@tphone/core/lib/vue-cli-plugin-uni/lib/app-plus/getUrl.js')
  moduleAlias.addAlias('vue-style-loader', '@tphone/core/lib/vue-cli-plugin-uni/packages/app-vue-style-loader')
}

if (process.env.UNI_PLATFORM === 'h5') {
  moduleAlias.addAlias(
    'vue-style-loader',
    path.resolve(process.cwd(), 'node_modules/@tphone/core/lib/vue-cli-plugin-uni/packages/h5-vue-style-loader')
    // 'vue-loader': path.resolve(process.cwd(), '@tphone/core/lib/vue-cli-plugin-uni/packages/vue-loader')
  );
  // moduleAlias.addAlias('vue-style-loader', '@tphone/core/lib/vue-cli-plugin-uni/packages/h5-vue-style-loader')
}
...
if (process.env.UNI_PLATFORM === 'mp-toutiao' || process.env.UNI_PLATFORM === 'mp-lark') {
  ...
  moduleAlias.addAlias(
    ...
    '@tphone/core/lib/vue-cli-plugin-uni/packages/postcss-normalize-whitespace'
  )
}
