...
const uniI18n = require('@tphone-beta/core/lib/uni-cli-i18n')
const moduleAlias = require('module-alias')

require('@tphone-beta/core/lib/vue-cli-plugin-uni/lib/error-reporting')
...
const manifestJsonObj = require('@tphone-beta/core/lib/uni-cli-shared/lib/manifest').getManifestJson()
...
// 初始化全局插件对象
global.uniPlugin = require('@tphone-beta/core/lib/uni-cli-shared/lib/plugin').init()
...
// 初始化环境变量
process.env.UNI_CLI_CONTEXT = require('@tphone-beta/core/lib/uni-cli-shared/lib/util').getCLIContext()
...
const {
  initUniModules
} = require('@tphone-beta/core/lib/uni-cli-shared/lib/uni_modules')
...
if (process.env.UNI_PLATFORM === 'h5') {
  ...
  if (optimization) {
    ...
    if (
      ...
      if (Array.isArray(treeShaking.modules) && treeShaking.modules.length) {
        const {
          parseUserApis
        } = require('@tphone-beta/core/lib/uni-cli-shared/lib/api')
        try {
          const modules = require('@tphone-beta/core/lib/uni-h5/lib/modules.json')
  ...
  const buffer = fs.readFileSync(require.resolve('@tphone-beta/core/lib/uni-h5/dist/index.css'))
...
if (process.env.UNI_USING_NATIVE || process.env.UNI_USING_V3_NATIVE) {
  ...
  try {
    let info = ''
    if (process.env.UNI_PLATFORM === 'app-plus') {
      const pagesPkg = require('@tphone-beta/core/lib/webpack-uni-pages-loader/package.json')
      if (pagesPkg) {
...
moduleAlias.addAlias('vue-template-compiler', '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/vue-template-compiler')
moduleAlias.addAlias('@megalo/template-compiler', '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/@megalo/template-compiler')
moduleAlias.addAlias('mpvue-template-compiler', '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/mpvue-template-compiler')
// vue-loader
moduleAlias.addAlias(
  'vue-loader',
  path.resolve(process.cwd(), 'node_modules/@tphone-beta/core/lib/vue-cli-plugin-uni/packages/vue-loader')
  // 'vue-loader': path.resolve(process.cwd(), '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/vue-loader')
);
// moduleAlias.addAlias('vue-loader', '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/vue-loader')
// sass-loader
moduleAlias.addAlias('sass-loader', '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/sass-loader')

if (process.env.UNI_USING_V3 && process.env.UNI_PLATFORM === 'app-plus') {
  moduleAlias.addAlias('./runtime/getUrl.js', '@tphone-beta/core/lib/vue-cli-plugin-uni/lib/app-plus/getUrl.js')
  moduleAlias.addAlias('../runtime/getUrl.js', '@tphone-beta/core/lib/vue-cli-plugin-uni/lib/app-plus/getUrl.js')
  moduleAlias.addAlias('vue-style-loader', '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/app-vue-style-loader')
}

if (process.env.UNI_PLATFORM === 'h5') {
  moduleAlias.addAlias(
    'vue-style-loader',
    path.resolve(process.cwd(), 'node_modules/@tphone-beta/core/lib/vue-cli-plugin-uni/packages/h5-vue-style-loader')
    // 'vue-loader': path.resolve(process.cwd(), '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/vue-loader')
  );
  // moduleAlias.addAlias('vue-style-loader', '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/h5-vue-style-loader')
}
...
if (process.env.UNI_PLATFORM === 'mp-toutiao' || process.env.UNI_PLATFORM === 'mp-lark') {
  ...
  moduleAlias.addAlias(
    ...
    '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/postcss-normalize-whitespace'
  )
}
...
if (
  ...
  if (!fs.existsSync(cacheJsonDir)) { //  创建 cache 目录
    ...
    require('@tphone-beta/core/lib/uni-cli-shared/lib/cache').restore()
  }
}
...
} = require('@tphone-beta/core/lib/uni-cli-shared/lib/pages')
...
if (
  ...
  const migrate = require('@tphone-beta/core/lib/uni-migration')
