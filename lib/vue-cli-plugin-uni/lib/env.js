...
const manifestJsonObj = require('@tphone/core/lib/uni-cli-shared/lib/manifest').getManifestJson()
...
// 初始化全局插件对象
global.uniPlugin = require('@tphone/core/lib/uni-cli-shared/lib/plugin').init()
...
// 初始化环境变量
process.env.UNI_CLI_CONTEXT = require('@tphone/core/lib/uni-cli-shared/lib/util').getCLIContext()
...
const {
  initUniModules
} = require('@tphone/core/lib/uni-cli-shared/lib/uni_modules')
  ...
  if (optimization) {
    ...
    if (
      ...
      if (Array.isArray(treeShaking.modules) && treeShaking.modules.length) {
        const {
          parseUserApis
        } = require('@tphone/core/lib/uni-cli-shared/lib/api')
        try {
...
if (
  ...
  if (!fs.existsSync(cacheJsonDir)) { //  创建 cache 目录
    ...
    require('@tphone/core/lib/uni-cli-shared/lib/cache').restore()
  }
}
...
} = require('@tphone/core/lib/uni-cli-shared/lib/pages')
