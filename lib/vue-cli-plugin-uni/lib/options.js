...
const {
  sassLoaderVersion
} = require('@tphone-beta/core/lib/uni-cli-shared/lib/scss')
...
module.exports = function initOptions (options) {
  ...
  options.transpileDependencies.push('@tphone-beta/core/lib/uni-i18n')
  options.transpileDependencies.push('@tphone-beta/core/lib/uni-stat')
  options.transpileDependencies.push('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/uni-app')
  options.transpileDependencies.push('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/uni-cloud')
  options.transpileDependencies.push('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/uni-stat')

  if (process.env.UNI_PLATFORM !== 'mp-weixin') { // mp runtime
    options.transpileDependencies.push('@tphone-beta/core/lib/uni-mp-weixin')
  }
