...
module.exports = function modifyVueLoader (webpackConfig, loaderOptions, compilerOptions, api) {
  ...
  if (process.env.UNI_PLATFORM === 'h5') {
    webpackConfig.module
      ...
      .loader(require.resolve('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/webpack-scoped-loader'))
  } else {
    webpackConfig.module
      .rule('vue')
      .use('uniapp-nvue-style-loader')
      .loader(require.resolve('@tphone-beta/core/lib/webpack-uni-mp-loader/lib/style.js'))
  }
  // 是否启用 cache
  if (process.env.UNI_USING_CACHE) {
    webpackConfig.module
