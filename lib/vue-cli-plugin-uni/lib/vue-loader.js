...
module.exports = function modifyVueLoader (webpackConfig, loaderOptions, compilerOptions, api) {
  ...
  //   .rule('yjpl')
  //   .test(vueLoader.yjplTest)
  //   .use('vue-loader')
  //   .loader(vueLoader.loader)
  //   .end()
  //   .use('yjpl-to-uni-loader')
  //   .loader(vueLoader.yjplLoader)
  //   .end()
  ...
  if (process.env.UNI_PLATFORM === 'h5') {
    webpackConfig.module
      ...
      .loader(require.resolve('@tphone/core/lib/vue-cli-plugin-uni/packages/webpack-scoped-loader'))
  } else {
    webpackConfig.module
      .rule('vue')
      .use('uniapp-nvue-style-loader')
      .loader(require.resolve('@tphone/core/lib/webpack-uni-mp-loader/lib/style.js'))
  }
  // 是否启用 cache
  if (process.env.UNI_USING_CACHE) {
    webpackConfig.module
