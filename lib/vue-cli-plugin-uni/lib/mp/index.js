...
module.exports = {
  ...
  webpackConfig (webpackConfig, vueOptions, api) {
    ...
    if (process.env.UNI_USING_VUE3) {
      alias.vuex = require.resolve('@tphone/core/lib/vue-cli-plugin-uni/packages/vuex')
      alias['@vue/devtools-api'] = require.resolve('@tphone/core/lib/vue-cli-plugin-uni/packages/@vue/devtools-api')

      alias['vue-i18n'] = require.resolve('@tphone/core/lib/vue-cli-plugin-uni/packages/vue3/node_modules/vue-i18n')
      alias['@dcloudio/uni-app'] = require.resolve('@tphone/core/lib/vue-cli-plugin-uni/packages/uni-app')
    }
