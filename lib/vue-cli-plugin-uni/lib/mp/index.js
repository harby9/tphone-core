  ...
  webpackConfig (webpackConfig, vueOptions, api) {
    ...
    const alias = { // 仅 mp-weixin
      'mpvue-page-factory': require.resolve(
        '@tphone/core/lib/vue-cli-plugin-uni/packages/mpvue-page-factory')
    }
      ...
      module: {
        rules: [{
          ...
          use: [{
            ...
            loader: '@tphone/core/lib/webpack-uni-mp-loader/lib/main'
          }]
        }, {
          resourceQuery: /vue&type=script/,
          use: [{
            loader: '@tphone/core/lib/webpack-uni-mp-loader/lib/script'
          }]
        }, {
          resourceQuery: /vue&type=template/,
          use: [{
            loader: '@tphone/core/lib/webpack-uni-mp-loader/lib/template'
          }, {
          ...
          use: [{
            loader: require.resolve(
              '@tphone/core/lib/vue-cli-plugin-uni/packages/webpack-uni-filter-loader')
          }]
        }]
      },
      plugins
