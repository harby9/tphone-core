...
function getProvides () {
  const uniPath = require('@tphone/core/lib/uni-cli-shared/lib/platform').getMPRuntimePath()
...
module.exports = {
  ...
  webpackConfig (webpackConfig, vueOptions, api) {
    ...
    const statCode = process.env.UNI_USING_STAT ? 'import \'@tphone/core/lib/uni-stat\';' : ''
    ...
    const alias = { // 仅 mp-weixin
      'mpvue-page-factory': require.resolve(
        '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/mpvue-page-factory')
    }

    if (process.env.UNI_USING_VUE3) {
      alias.vuex = require.resolve('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/vuex')
      alias['@vue/devtools-api'] = require.resolve('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/@vue/devtools-api')

      alias['vue-i18n'] = require.resolve('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/vue3/node_modules/vue-i18n')
      alias['@dcloudio/uni-app'] = require.resolve('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/uni-app')
    }
      ...
      module: {
        rules: [{
          ...
          use: [{
            ...
            loader: '@tphone-beta/core/lib/webpack-uni-mp-loader/lib/main'
          }]
        }, {
          resourceQuery: /vue&type=script/,
          use: [{
            loader: '@tphone-beta/core/lib/webpack-uni-mp-loader/lib/script'
          }]
        }, {
          resourceQuery: /vue&type=template/,
          use: [{
            loader: '@tphone-beta/core/lib/webpack-uni-mp-loader/lib/template'
          }, {
          ...
          use: [{
            loader: require.resolve(
              '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/webpack-uni-filter-loader')
          }]
        }]
      },
      plugins
