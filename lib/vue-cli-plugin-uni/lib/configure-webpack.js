...
} = require('@tphone-beta/core/lib/vue-cli-plugin-uni/lib/util')
...
module.exports = function configureWebpack (platformOptions, manifestPlatformOptions, vueOptions, api) {
  ...
  const {
    getPlatformVue
  } = require('@tphone-beta/core/lib/uni-cli-shared/lib/platform')

  const {
    getCopyWebpackPluginOptions
  } = require('@tphone-beta/core/lib/vue-cli-plugin-uni/lib/copy-webpack-options')
  ...
  const tsLoaderOptions = {
    ...
    compilerOptions: {
      ...
      typeRoots: [resolveModule('@tphone-beta/core/lib/types'), resolveModule('@types')],
      types: [
        'uni-app',
        'webpack-env'
      ],
      paths: {
        ...
        'mpvue-page-factory': [
          resolveModule('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/mpvue-page-factory')
        ]
      }
    },
  ...
  return function (webpackConfig) {
    ...
    if (require('@tphone-beta/core/lib/uni-cli-shared/lib/util').isInHBuilderX) {
    ...
    if (process.env.NODE_ENV === 'development') {
      const sourceMap = require('@tphone-beta/core/lib/uni-cli-shared/lib/source-map')
    ...
    moduleAlias.addAliases({
      '@vue/cli-plugin-babel': path.resolve(process.cwd(), 'node_modules/@vue/cli-plugin-babel')
    });
    ...
    return merge({
      ...
      resolve: {
        alias: {
          ...
          '@tphone-beta/core/lib/uni-stat': process.env.UNI_USING_VUE3 ? require.resolve(
            '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/uni-stat') : require
            .resolve('@tphone-beta/core/lib/uni-stat'),
          'uni-stat-config': path.resolve(process.env.UNI_INPUT_DIR, 'pages.json') +
            '?' +
            JSON.stringify({
              type: 'stat'
            }),
          vuex: require.resolve('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/vuex3')
        },
        modules: [
      ...
      watchOptions: require('@tphone-beta/core/lib/vue-cli-plugin-uni/lib/util').getWatchOptions()
