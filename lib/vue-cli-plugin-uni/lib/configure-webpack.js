...
module.exports = function configureWebpack (platformOptions, manifestPlatformOptions, vueOptions, api) {
  ...
  const {
    getPlatformVue
  } = require('@tphone/core/lib/uni-cli-shared/lib/platform')
  ...
  return function (webpackConfig) {
    ...
    if (require('@tphone/core/lib/uni-cli-shared/lib/util').isInHBuilderX) {
    ...
    if (process.env.NODE_ENV === 'development') {
      const sourceMap = require('@tphone/core/lib/uni-cli-shared/lib/source-map')
