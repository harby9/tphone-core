...
} = require('@tphone/core/lib/vue-cli-plugin-uni/lib/util')
...
module.exports = function configureWebpack (platformOptions, manifestPlatformOptions, vueOptions, api) {
  ...
  } = require('@tphone/core/lib/vue-cli-plugin-uni/lib/copy-webpack-options')
  ...
  return function (webpackConfig) {
    ...
    return merge({
      ...
      watchOptions: require('@tphone/core/lib/vue-cli-plugin-uni/lib/util').getWatchOptions()
