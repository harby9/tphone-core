  ...
  const tsLoaderOptions = {
    ...
    compilerOptions: {
      ...
      paths: {
        ...
        'mpvue-page-factory': [
          resolveModule('@tphone/core/lib/vue-cli-plugin-uni/packages/mpvue-page-factory')
        ]
      }
    },
  ...
  return function (webpackConfig) {
    ...
    const rules = [{
      ...
      use: [{
        ...
        loader: '@tphone/core/lib/webpack-uni-pages-loader'
      }],
      ...
      resolve: {
        alias: {
          ...
          '@tphone/core/lib/uni-stat': process.env.UNI_USING_VUE3 ? require.resolve(
            '@tphone/core/lib/vue-cli-plugin-uni/packages/uni-stat') : require
