...
module.exports = async function checkUpdate () {
  ...
  const plp = require('@tphone-beta/core/lib/webpack-uni-pages-loader/package.json')
  ...
  try {
    ...
    update.isAlpha = ppj.devDependencies['@tphone-beta/core/lib/vue-cli-plugin-uni'].includes('alpha')
