...
const runtimePath = '@tphone-beta/core/lib/uni-mp-weixin/dist/mp.js'
const wxsPath = '@tphone-beta/core/lib/uni-mp-weixin/dist/wxs.js'
    ...
    return {
      resolve: {
        ...
        alias: {
          ...
          'uni-h5': require.resolve('@tphone-beta/core/lib/uni-h5')
        }
      },
      module: {
        rules: [{
