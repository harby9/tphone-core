...
const runtimePath = '@tphone/core/lib/uni-mp-weixin/dist/mp.js'
const wxsPath = '@tphone/core/lib/uni-mp-weixin/dist/wxs.js'
    ...
    return {
      resolve: {
        ...
        alias: {
          ...
          'uni-h5': require.resolve('@tphone/core/lib/uni-h5')
        }
      },
      module: {
        rules: [{
