...
const { compileI18nJsonStr } = require('@tphone-beta/core/lib/uni-i18n')
const { initI18nOptions } = require('@tphone-beta/core/lib/uni-cli-shared/lib/i18n')
...
function getCopyWebpackPluginOptions (platformOptions, vueOptions) {
  ...
  if (process.env.UNI_PLATFORM === 'app-plus') {
    copyOptions.push({
      ...
      to: '[name].[ext]',
      globOptions: {
        ignored: require('@tphone-beta/core/lib/vue-cli-plugin-uni/lib/util').getWatchOptions().ignored
      },
