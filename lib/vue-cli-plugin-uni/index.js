...
} = require('@tphone/core/lib/vue-cli-plugin-uni/lib/env')

const {
  assetsDir
} = require('@tphone/core/lib/vue-cli-plugin-uni/lib/copy-webpack-options')

require('@tphone/core/lib/vue-cli-plugin-uni/lib/check-update')()

const initBuildCommand = require('@tphone/core/lib/vue-cli-plugin-uni/commands/build')
const initServeCommand = require('@tphone/core/lib/vue-cli-plugin-uni/commands/serve')
...
module.exports = (api, options) => {
  ...
  if (process.env.UNI_PLATFORM === 'quickapp-native') {
    ...
    require('@tphone/core/lib/vue-cli-plugin-uni/lib/options')(options)
    const platformOptions = {
      webpackConfig: {},
      chainWebpack () {}
    }
    const manifestPlatformOptions = {}
    api.configureWebpack(require('@tphone/core/lib/vue-cli-plugin-uni/lib/configure-webpack')(platformOptions, manifestPlatformOptions, options, api))
    api.chainWebpack(require('@tphone/core/lib/vue-cli-plugin-uni/lib/chain-webpack')(platformOptions, options, api))
