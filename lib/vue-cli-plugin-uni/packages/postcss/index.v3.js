...
const TAGS = Object.keys(require('@tphone-beta/core/lib/uni-cli-shared').tags)
...
module.exports = postcss.plugin('postcss-uniapp-plugin', function (opts) {
  return function (root, result) {
    if (!rewriteUrl) {
      rewriteUrl = require('@tphone-beta/core/lib/uni-cli-shared/lib/url-loader').rewriteUrl
    }
    rewriteUrl(root)
