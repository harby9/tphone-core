...
const parseStyle = require('@tphone/core/lib/webpack-uni-pages-loader/lib/util').parseStyle
...
module.exports = function (content, map) {
  ...
  if (process.env.UNI_PLATFORM === 'h5') {
    return this.callback(
      null,
      require('@tphone/core/lib/webpack-uni-pages-loader/lib/platforms/h5')(pagesJson, manifestJson, this),
      map
    )
  }
  if (process.env.UNI_PLATFORM === 'quickapp-native') {
    return this.callback(
      null,
      require('@tphone/core/lib/webpack-uni-pages-loader/lib/platforms/quickapp-native')(pagesJson, manifestJson, this),
      map
    )
  }
  // 仅限小程序
