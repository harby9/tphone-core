...
const {
  ...
  updatePageJson,
  updateProjectJson
} = require('@tphone-beta/core/lib/uni-cli-shared/lib/cache')

const {
  initTheme,
  parseTheme
} = require('@tphone-beta/core/lib/uni-cli-shared/lib/theme')
...
const parseStyle = require('@tphone-beta/core/lib/webpack-uni-pages-loader/lib/util').parseStyle

const {
  initI18nOptions
} = require('@tphone-beta/core/lib/uni-cli-shared/lib/i18n')
const {
  parseI18nJson
} = require('@tphone-beta/core/lib/uni-i18n')
...
module.exports = function (content, map) {
  ...
  if (process.env.UNI_PLATFORM === 'h5') {
    return this.callback(
      null,
      require('@tphone-beta/core/lib/webpack-uni-pages-loader/lib/platforms/h5')(pagesJson, manifestJson, this),
      map
    )
  }
  if (process.env.UNI_PLATFORM === 'quickapp-native') {
    return this.callback(
      null,
      require('@tphone-beta/core/lib/webpack-uni-pages-loader/lib/platforms/quickapp-native')(pagesJson, manifestJson, this),
      map
    )
  }
  // 仅限小程序
