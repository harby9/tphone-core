...
const validate = require('@tphone/core/lib/uni-migration/lib/validate')

const patchVant = require('@tphone/core/lib/uni-migration/lib/vant')

const migraters = {
  'mp-weixin': require('@tphone/core/lib/uni-migration/lib/mp-weixin')
}
