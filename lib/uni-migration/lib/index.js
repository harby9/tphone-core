...
const validate = require('@tphone-beta/core/lib/uni-migration/lib/validate')

const patchVant = require('@tphone-beta/core/lib/uni-migration/lib/vant')

const migraters = {
  'mp-weixin': require('@tphone-beta/core/lib/uni-migration/lib/mp-weixin')
}
