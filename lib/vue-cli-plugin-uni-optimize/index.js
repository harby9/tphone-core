...
const WebpackOptimizePlugin = require('@tphone-beta/core/lib/vue-cli-plugin-uni-optimize/packages/webpack-optimize-plugin')

const {
  src,
  lib
} = require('@tphone-beta/core/lib/uni-h5/path')
