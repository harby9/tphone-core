...
const preprocessor = require('@tphone-beta/core/lib/vue-cli-plugin-uni/packages/webpack-preprocess-loader/preprocess')

const traverse = require('@tphone-beta/core/lib/webpack-uni-mp-loader/lib/babel/scoped-component-traverse')

const {
  resolve,
  normalizeNodeModules
} = require('@tphone-beta/core/lib/webpack-uni-mp-loader/lib/shared')

const {
  findBabelLoader,
  addDynamicImport
} = require('@tphone-beta/core/lib/webpack-uni-mp-loader/lib/babel/util')
