...
} = require('@tphone/core/lib/uni-cli-shared/lib/util')
...
const uniPluginOptions = global.uniPlugin && global.uniPlugin.options || {}

const {
  vueContext: preprocessContext,
  nvueContext: nvuePreprocessContext
} = global.uniPlugin && global.uniPlugin.preprocess || {}
...
module.exports = {
  ...
  getPlatforms () {
    return global.uniPlugin && global.uniPlugin.platforms
  },
  ...
  getPlatformVue (vueOptions) {
    ...
    if (process.env.UNI_USING_VUE3) {
      return '@tphone-beta/core/lib/uni-mp-vue'
    }
    return '@tphone-beta/core/lib/vue-cli-plugin-uni/packages/mp-vue'
  },
  getPlatformCssVars () {
